...
INSERT INTO "new_Document" ("createdAt", "customerId", "depositCents", "docNumber", "docType", "dueDate", "grossTotalCents", "id", "issueDate", "netTotalCents", "notesInternal", "notesPublic", "status", "taxMode", "updatedAt", "validUntil", "vatTotalCents", "vehicleId") SELECT "createdAt", "customerId", "depositCents", "docNumber", "docType", "dueDate", "grossTotalCents", "id", "issueDate", "netTotalCents", "notesInternal", "notesPublic", "status", "taxMode", "updatedAt", "validUntil", "vatTotalCents", "vehicleId" FROM "Document";
DROP TABLE "Document";
