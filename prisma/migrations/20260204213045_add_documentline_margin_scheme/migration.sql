...
CREATE TABLE "new_DocumentLine" (
    ...
    "isMarginScheme" BOOLEAN NOT NULL DEFAULT false,
    "description" TEXT,
...
INSERT INTO "new_DocumentLine" ("createdAt", "description", "discountPct", "documentId", "id", "lineGrossCents", "lineNetCents", "lineVatCents", "position", "qty", "title", "unitNetCents", "updatedAt", "vatRate") SELECT "createdAt", "description", "discountPct", "documentId", "id", "lineGrossCents", "lineNetCents", "lineVatCents", "position", "qty", "title", "unitNetCents", "updatedAt", "vatRate" FROM "DocumentLine";
