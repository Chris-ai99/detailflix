...
INSERT INTO "new_DocumentLine" ("createdAt", "documentId", "id", "lineGrossCents", "lineNetCents", "lineVatCents", "position", "qty", "title", "unitNetCents", "updatedAt", "vatRate") SELECT "createdAt", "documentId", "id", "lineGrossCents", "lineNetCents", "lineVatCents", "position", "qty", "title", "unitNetCents", "updatedAt", "vatRate" FROM "DocumentLine";
