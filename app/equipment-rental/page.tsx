...
export default function EquipmentRentalPage() {
  return (
    <div className="space-y-4">
      <div className="text-sm text-slate-300">Ger&#228;temiete</div>
      <div className="rounded border border-amber-500/30 bg-amber-500/10 px-4 py-3 text-amber-100">
        ...
        <div className="mt-1 text-xs">
          Dieses Modul ist noch nicht aktiviert. Hier kann sp&#228;ter die Vermietung von
          Ger&#228;ten abgebildet werden.
        </div>
      </div>
      <Link
        href="/dashboard"
